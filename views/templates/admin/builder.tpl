...
<input type="hidden" {if $slides|@count > 1}data-help="0"{else}data-help="1"{/if} {if isset($slide) && isset($slide->builder) && empty($slide->builder) == false}value="{$slide->builder|escape:'UTF-8'}"{else}value="{$default_code|urlencode|escape:'UTF-8'}"{/if} name="builder" id="builder" />
