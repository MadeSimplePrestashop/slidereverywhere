...
}}if(Firebug.Inspector){this.inspectButton.initialize();this.inspectButton.onPress()
...
this.close();var doc = FirebugChrome.chromeMap.frame.document;var mini = $("fbMiniChrome", doc);mini.style.display = "none";
...
}selectElem(targ);Firebug.Inspector.stopInspecting()
