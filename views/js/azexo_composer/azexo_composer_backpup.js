...
//
    ...
    mixin(CarouselElement.prototype, {
        ...
        add_slide: function() {
            var child = new SlideElement(this, true); // edited kuzmany
            var child2 = new LayersElement(child, true); // edited kuzmany
            console.log(child2);
            child2.update_dom();
            child.update_dom();
            this.update_dom(); 
            //var child2 = new LayersElement(this, true); // edited kuzmany
            //child2.update_dom();
            //this.update_dom(); 
        },
