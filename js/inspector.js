...
$('body').append('<div id="inspector-tools"><input .placeholder="Click on position  and save it!" id="inspector-text" class="text" type="text">\n\
<select><option value="">after select element</option><option value="">before select element</option></select><select><option>everyhwre</option><option value="url">On this url</option><option class="controller">on this controller</option></select><input class="submit" value="Save and close" type="submit"></div>')
